    ...
    <modal ref="editor" :title="title" class="w-full lg:w-1/2 lg:top-12 lg:left-1/4 text-gray-300">
        ...
        <div class="modal-row-10">
            ...
            <input
                ...
                type="text"
                :placeholder="state.data.raw_name"
                v-model="state.data.raw_name"
            />
        </div>
        <editor-string-array
            :title="'Other Names'"
            :state="state"
            :state-key="'data.other_names'"
        ></editor-string-array>
        ...
        <div class="modal-row-10">
            ...
            <input
                class="modal-input w-28 3xl:w-48 ml-2"
                type="text"
                placeholder="±hh:mm"
                v-model="publication.timezone"
            />
        </div>
        <div class="modal-row">
        ...
        <div
            ...
            :key="JSON.stringify(state.data.tags[field])"
        >
