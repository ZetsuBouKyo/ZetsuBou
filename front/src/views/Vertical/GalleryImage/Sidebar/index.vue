        ...
        >
            ...
            >
                ...
                <div class="flex flex-row" v-if="state.sidebar.polygon.currentID !== undefined">
                    ...
                    <div class="modal-row-10">
                        <switch-element
                            v-model="state.sidebar.polygon.polygons[state.sidebar.polygon.currentID].isVisible"
                        />
                    </div>
                </div>
                <div class="flex flex-row" v-if="state.sidebar.polygon.currentID !== undefined">
                    ...
                    <div class="modal-row-10">
                        <switch-element
                            v-model="state.sidebar.polygon.polygons[state.sidebar.polygon.currentID].isCompleted"
                        />
                    </div>
                </div>
            </div>
