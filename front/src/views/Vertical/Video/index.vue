            ...
            <div class="flex flex-row">
                <div class="flex flex-col flex-1">
                    ...
                    <div class="flex flex-row items-center text-white 3xl:text-2xl text-xl font-medium mt-2 mb-1">
                        <h1
                            class="lg:w-full w-80 hover:opacity-50 cursor-pointer break-all"
                            v-if="videoState.data.name"
                        >
                    ...
                    <div class="ml-auto 3xl:text-xl">
                        <a class="text-gray-300" v-if="videoState.data.src.length > 0" :href="videoState.data.src[0]">
                            {{ videoState.data.src[0] }}
                        </a>
                    </div>
                    <div class="flex flex-col divide-y divide-gray-500">
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-row-reverse">
                                ...
                                <ripple-button
                                    class="flex btn hover:opacity-50 hover:bg-gray-500"
